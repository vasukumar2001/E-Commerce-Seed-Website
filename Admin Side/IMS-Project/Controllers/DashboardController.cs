...
namespace IMS_Project.Controllers
{
    public class DashboardController : Controller
    {
        ...
        {          
            ...
            ViewBag.NewOrders = db.Orders.Where(a => a.StatusId == 1).Count();
            ViewBag.DispatchedOrders = db.Orders.Where(a => a.StatusId == 3).Count();
            ViewBag.ShippedOrders = db.Orders.Where(a => a.StatusId == 2 ).Count();
            ViewBag.DeliveredOrders = db.Orders.Where(a => a.StatusId == 4 ).Count();
